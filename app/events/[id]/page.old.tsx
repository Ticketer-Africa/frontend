 ...
 */
const ResaleTicketCard = memo(function ResaleTicketCard({
  ticket,
  onBuy,
}: {
  ticket: TicketResale;
 ...
 */
const TicketCategoryCard = memo(function TicketCategoryCard({
  ticketCategory,
  isSelected,
  onSelect,
  onRemove,
...
export default function EventPage({ params }: { params: { id: string } }) {
   ...
   * Important for memoized child components that receive these as props
   */
  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              {/* Description - CSS animation instead of framer-motion */}
              ...
              {/* Organizer Info - CSS animation with delay */}
              ...
              {/* Resale Tickets - CSS animation with delay */}
            ...
            {/* Sidebar - CSS animations instead of framer-motion */}
      ...
      {/* Floating Cart - CSS animation instead of framer-motion */}
