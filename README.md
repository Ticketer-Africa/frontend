...
This repository and all source code, assets, and documentation contained herein are the intellectual property of **Ticketer Africa** (“the Company”).
...
- No portion of this codebase may be used, reproduced, or distributed without **express written permission** from Ticketer Africa.
...
It is not open source. All rights are retained by **Ticketer Africa**.
